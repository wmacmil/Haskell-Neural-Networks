...
/* package Haskell-Neural-Networks-0.1.0.0 */
#ifndef VERSION_Haskell_Neural_Networks
#define VERSION_Haskell_Neural_Networks "0.1.0.0"
#endif /* VERSION_Haskell_Neural_Networks */
#ifndef MIN_VERSION_Haskell_Neural_Networks
#define MIN_VERSION_Haskell_Neural_Networks(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Neural_Networks */
...
#define CURRENT_PACKAGE_KEY "Haskell-Neural-Networks-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "Haskell-Neural-Networks-0.1.0.0-inplace"
